...
export function SearchBar({
  ...
  return (
    <div className="card-input flex min-h-touch items-center gap-8 rounded-2xl px-12">
      ...
      {value && (
        <button
          ...
          className="flex size-32 shrink-0 items-center justify-center rounded-xl text-text-tertiary hover:text-text-primary"
        >
