...
export function OnboardingFlow() {
  ...
  // The current step registers its submit handler (data collection + advance)
  // here so the single footer "Next" button can drive it — no per-step
  // "Continue" button. Auto-advancing steps (Welcome, Risk) register nothing,
  // and "Next" just moves forward.
  const submitRef = useRef<(() => void) | null>(null)
  const registerNext = useCallback((submit: (() => void) | null) => {
