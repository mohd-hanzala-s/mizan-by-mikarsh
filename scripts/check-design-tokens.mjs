...
const ALLOWED_SPACING = new Set([
  0, 1, 2, 3, 4, 6, 8, 10, 12, 14, 16, 18, 20, 24, 28, 32, 36, 40, 48, 56, 64, 80, 96, 128, 192,
])
const ALLOWED_RADIUS = new Set(['none', 'sm', 'md', 'lg', 'xl', '2xl', '3xl', 'full', 'modal'])
const ALLOWED_BARE_RADIUS = true
const RAW_PALETTE = [
  'red',
  'blue',
  'green',
