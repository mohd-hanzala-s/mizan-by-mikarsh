...
import { getPayoffForecast, isOverdue, nextDueDate } from '@/services/LoanService'
...
export function LoanCard({
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-md border border-border bg-surface-card">
      <div className="flex flex-col gap-12 p-16">
        ...
        <div className="flex flex-wrap gap-8 border-t border-border-subtle pt-12">
          ...
          <button
            ...
            aria-controls={`loan-payments-${loan.id}`}
      ...
      {expanded && (
        <div
          id={`loan-payments-${loan.id}`}
          className="flex flex-col divide-y divide-border-subtle border-t border-border bg-neutral-50 dark:bg-neutral-900"
        >
          {payments.length === 0 ? (
                ...
                <div className="flex items-center justify-between gap-8">
                  <div className="min-w-0">
                    <p className="text-body-sm text-text-secondary">
                      {format(startOfStoredDate(p.paymentDate), 'd MMM yyyy')}
                    </p>
                  ...
                  <div className="flex shrink-0 items-center gap-8">
                    ...
                    <button
                      ...
                      className="flex size-48 items-center justify-center rounded-md text-text-tertiary transition-colors duration-fast hover:bg-neutral-100 hover:text-expense dark:hover:bg-neutral-800"
                    >
