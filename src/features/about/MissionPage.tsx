...
const VALUES: Value[] = [
  {
    ...
    label: 'Balance',
    description:
      'We design for equilibrium — between power and simplicity, depth and clarity, control and ease.',
  },
  {
    icon: Lock,
    label: 'Privacy',
    description:
      'Your financial life belongs to you alone. Every design decision starts with this commitment.',
  },
  {
    icon: Layout,
    label: 'Simplicity',
    description:
      'Complexity is easy. Removing it without losing capability is art. We chase that art every day.',
  },
  {
    icon: ShieldCheck,
    label: 'Trust',
    description:
      'We earn trust through transparency, not through promises. You can see exactly how your data is handled.',
  },
  {
    icon: Gem,
    label: 'Longevity',
    description:
      'We build for decades, not quarters. Mizan is designed to grow with you, not to chase trends.',
  },
]
      ...
      <div className="flex flex-col gap-20 px-20 pb-32 md:px-32">
        <section className="card rounded-2xl p-20 md:p-28">
          ...
          <p className="text-body-lg leading-relaxed text-text-secondary">
            To give every person a beautiful, private, and powerful tool for mastering their
            financial life — without compromising their data, their attention, or their peace of
            mind.
          </p>
        </section>
        ...
        <section className="card rounded-2xl p-20 md:p-28">
          ...
          <p className="text-body-lg leading-relaxed text-text-secondary">
            A world where managing money feels effortless and empowering — where financial clarity
            is accessible to everyone, not just those who can afford premium services or sacrifice
            their privacy.
          </p>
        </section>
        ...
        <section className="card rounded-2xl p-20 md:p-28">
          ...
          <p className="text-body-lg leading-relaxed text-text-secondary">
            Beautiful craftsmanship meets intentional restraint. Our design language draws from the
            clarity of Apple, the precision of Linear, and a touch of soft depth that makes every
            interaction feel warm and human. Deep Emerald Green signals trust and growth, while Gold
            accents mark moments of insight and achievement. Every pixel, every animation, every
            spacing decision is deliberate — because beauty and usability are not separate goals.
          </p>
        </section>
      </div>
    </div>
