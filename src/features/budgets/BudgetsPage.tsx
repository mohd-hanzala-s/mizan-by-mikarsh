...
import { EmptyBudgetsIllustration } from '@/components/common/Illustrations'
...
export function BudgetsPage() {
  ...
  if (budgets.length === 0) {
    return (
      <>
        <EmptyState
          illustration={<EmptyBudgetsIllustration size={140} />}
      ...
      >
        ...
        {editing && (
          <button
            ...
            className="mt-16 flex min-h-touch w-full items-center justify-center text-center text-body-sm text-expense"
          >
            Delete this budget
          </button>
        )}
