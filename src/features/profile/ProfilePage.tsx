        ...
        {openSections.has('summary') && (
          <div className="border-t border-border-subtle px-16 py-16">
            <div className="divide-y divide-border-subtle">
              ...
              <StatRow
                label="Active Goals"
                value={`${activeGoals.length} · ${formatAmount(goalsTargetTotal, currencyDisplay)} target`}
              />
              <StatRow
                label="Active Loans"
                value={`${activeLoans.length} · ${formatAmount(loansBalanceTotal, currencyDisplay)} balance`}
              />
              <StatRow label="Active Budgets" value={String(activeBudgets.length)} />
              <StatRow
                label="Total Investments"
                value={formatAmount(investmentsTotal, currencyDisplay)}
              />
